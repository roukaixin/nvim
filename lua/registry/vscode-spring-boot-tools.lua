return {
	...
	description = "VS Code Language Server for Spring Boot,VSCode extension and Language Server providing support for working with Spring Boot application.properties,application.yml and .java files. \n Note: this extension has a dependency on VS Code extension of Language Support for Java™ by Red Hat.",
	categories = { "LSP" },
